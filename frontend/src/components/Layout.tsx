        ...
        <div className="sm:hidden fixed inset-x-0 top-14 z-40 glass border-b shadow-lg animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="flex flex-col p-3 gap-1">
            ...
            {token ? (
              ...
              <Link 
                to="/login" 
                className="px-3 py-2.5 rounded-lg text-sm font-medium text-brand-600 hover:bg-brand-50 dark:text-brand-400 dark:hover:bg-brand-900/20 transition-colors"
              >
                Admin Login
              </Link>
            )}
